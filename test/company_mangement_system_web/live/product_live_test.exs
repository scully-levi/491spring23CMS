defmodule CompanyMangementSystemWeb.ProductLiveTest do
  use CompanyMangementSystemWeb.ConnCase

  import Phoenix.LiveViewTest
  import CompanyMangementSystem.StoreManagementSystemFixtures

  @create_attrs %{inventoryCount: 42, retailPrice: 120.5, vendor: "some vendor", wholesalePrice: 120.5}
  ...
  describe "Index" do
    ...
    test "updates product in listing", %{conn: conn, product: product} do
      ...
      assert html =~ "some updated vendor"
    end
