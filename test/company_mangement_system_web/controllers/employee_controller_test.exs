defmodule CompanyMangementSystemWeb.EmployeeControllerTest do
  use CompanyMangementSystemWeb.ConnCase

  import CompanyMangementSystem.HumanResourcesFixtures

  @create_attrs %{date_of_hire: ~D[2023-04-21], department: "some department", employee_id: 42, first_name: "some first_name", last_name: "some last_name"}
  @update_attrs %{date_of_hire: ~D[2023-04-22], department: "some updated department", employee_id: 43, first_name: "some updated first_name", last_name: "some updated last_name"}
