defmodule CompanyMangementSystem.HumanResourcesTest do
  ...
  describe "employees" do
    ...
    test "create_employee/1 with valid data creates a employee" do
      valid_attrs = %{date_of_hire: ~D[2023-04-21], department: "some department", employee_id: 42, first_name: "some first_name", last_name: "some last_name"}
    ...
    test "update_employee/2 with valid data updates the employee" do
      ...
      assert employee.date_of_hire == ~D[2023-04-22]
