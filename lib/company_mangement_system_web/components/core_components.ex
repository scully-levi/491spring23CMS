defmodule CompanyMangementSystemWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CompanyMangementSystemWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CompanyMangementSystemWeb.Gettext, "errors", msg, opts)
    end
  end
